...
class Jiankang extends Component {
...
this.selectDevices ={};
  ...
  render() {
    ...
    return (<div className='jiankangfenxi theBody' style={BodyStyle}>
...
export default connect(state => null, mapDispatchToProps)(Jiankang);
