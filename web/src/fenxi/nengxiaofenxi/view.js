...
class NengxiaoFenxi extends Component {
  ...
  render() {
          ...
          series: {
                  ...
                  scatters:[

                      {
                         ...
                         // symbolSize: 20,
                         // 
                         // admin: ministrator 水泵101：102水泵102,水泵选择，修改，定修改
    ...
    return (<div className='nengxiaofenxi theBody' style={BodyStyle}>
       ...
       <div className="charts-wrap" >
            <div className="left-charts" >
              ...
              <div className="charts-body">
                  <ReactEcharts option={GeneralCharts.theLineBar( DaBiaoLvOption )} style={{height:"220px" ,width:"100%"}} className='div1'/>
                </div>
            </div>
...
export default connect(state => null, mapDispatchToProps)(NengxiaoFenxi);
