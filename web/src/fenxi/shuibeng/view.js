...
class Shuibeng extends Component {
...
this.selectDevices ={};
  ...
  render() {
    ...
    return (<div className='shuibengfenxi theBody' style={BodyStyle}>
...
export default connect(state => null, mapDispatchToProps)(Shuibeng);
