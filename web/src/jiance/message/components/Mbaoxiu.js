...
import ss from './photo.js'

export default class Mbaoxiu extends Component {
    static contextTypes = {
    ...
    render() {
        ...
        let weihushebei=this.context.allData.Mweihulist
        const {fetchweuhushebei} = this.context.allData.Mweihulist;
        ...
        return (
            ...
            <div className="home weihu">
                <div className="wh_cekuang">
                    <div className="wh_ck_head">
                        <div className="wh_ck_back" onClick={this.clickclose.bind(this)} ><img src={require('../mobile/img/back_hei.png')} alt="" /></div>
                    ...
                    <div className="wh_ck_bzcont">
                        <form id="yourformid"   encType="multipart/form-data" method="post">
                            <div className="wh_ck_bzcont1">
                                ...
                                <img src={require('../mobile/img/xiala.png')} alt="" />
                            </div>
                            ...
                            <div className="wh_ck_bzcont5">
                                ...
                                <div className="wtms_con">
                                    <textarea rows="3" cols="50" name="describe">
                                        水泵底部震动过大，有异响。
                                    </textarea>
                                </div>
                            </div>
                            <ul className="paizhao">
                                <li className="telphoto">
                                    ...
                                    <img className="photoBar" src={require('../mobile/img/poto_img.png')} alt="" />
                                </li>
                ...
                <div className="load"><img  src={require('../mobile/img/load.gif')} alt="" /></div>
            </div>
            </div>
