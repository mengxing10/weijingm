...
class Mweixiu extends Component {
    static contextTypes = {
    ...
    render() {
        ...
        console.log(path)
        let newSelect=[]
        if(fetchweuhushebei=="done"){
           for(var i= 0;i<weihushebei.data.length;i++){
               newSelect.push({key:weihushebei.data[i].id,value:weihushebei.data[i].id,text:weihushebei.data[i].name})
           }
            ...
            <div className="home baoxiu">
                <div className="wh_cekuang">
                        <div className="wh_ck_head">
                            <div className="wh_ck_title">维修</div>
                            ...
                            <form id="yourformid"   encType="multipart/form-data" method="post">
                                ...
                                <div className="wh_ck_bzcont3">
                                    ...
                                    <div className="bxr_con">
                                        <input type="text"  placeholder="维修人" name="creatname"  />
                                    </div>
                                </div>
                                ...
                                <div className="wh_ck_bzcont5">
                                    ...
                                    <div className="wtms_con">
                                        <textarea rows="3" cols="50" name="describe" placeholder="水泵底部震动过大，有异响。">
                                        </textarea>
                                    </div>
                                </div>
                    ...
                    <div className="wh_foot">
                        ...
                        <div className="wh_foot_rg" >维修</div>
                    </div>
    ...
    componentDidMount(){
        ...
        $(".wh_foot_rg").unbind("click").click(function(){
            ...
            var  baseUrl=ips+'upload/MaintainUpload';
...
export default connect(state => state.xiaoxi, mapDispatchToProps)(Mweixiu);
