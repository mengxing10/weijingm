...
import './view.styl'
 ...
 class Jisuandianguanli extends Component {
    constructor(props) {
        super(props)
        this.state = {
          data:{pagename:'guanli_jisuandian',d1:{status:2,data:{header:[],result:[],page:{pageNum:1,pageSize:20,totalCount:3}}},d2:{}}
        }
    }
...
export default connect(state => state.jiancejisuanm, mapDispatchToProps)(Jisuandianguanli);
